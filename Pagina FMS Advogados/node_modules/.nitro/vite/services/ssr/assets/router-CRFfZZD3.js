...
import { X, Menu, Instagram, Facebook, MapPin, Phone, Mail } from "lucide-react";
...
function Header() {
  ...
  return /* @__PURE__ */ jsxs(
    "header",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { className: "mx-auto flex max-w-7xl items-center justify-between px-6 py-5 lg:px-10", children: [
          /* @__PURE__ */ jsx(Link, { to: "/", className: "font-display text-xl tracking-wide", children: business.name }),
          /* @__PURE__ */ jsx("nav", { className: "hidden items-center gap-9 lg:flex", children: navLinks.map((link) => /* @__PURE__ */ jsx(
            Link,
            {
              to: link.to,
              className: cn(
          ...
          /* @__PURE__ */ jsx("div", { className: "hidden lg:block", children: /* @__PURE__ */ jsx(Button, { asChild: true, size: "sm", variant: solid ? "default" : "ivory", children: /* @__PURE__ */ jsx(Link, { to: "/book", children: "Agendar Agora" }) }) }),
          /* @__PURE__ */ jsx(
            "button",
            {
        ...
        mobileOpen ? /* @__PURE__ */ jsx("div", { className: "border-t border-border bg-background px-6 py-6 text-foreground lg:hidden", children: /* @__PURE__ */ jsxs("nav", { className: "flex flex-col gap-5", children: [
          ...
          /* @__PURE__ */ jsx(Button, { asChild: true, size: "sm", onClick: () => setMobileOpen(false), children: /* @__PURE__ */ jsx(Link, { to: "/book", children: "Agendar Agora" }) })
        ] }) }) : null
      ]
    }
  );
...
function Footer() {
  return /* @__PURE__ */ jsx("footer", { className: "site-footer border-t border-border bg-foreground text-ivory", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-7xl px-6 py-20 lg:px-10", children: [
    /* @__PURE__ */ jsxs("div", { className: "grid gap-12 lg:grid-cols-[1.4fr_1fr_1fr_1.2fr]", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("p", { className: "font-display text-2xl", children: business.name }),
        /* @__PURE__ */ jsx("p", { className: "mt-4 max-w-xs text-sm leading-relaxed text-ivory/70", children: business.tagline }),
        /* @__PURE__ */ jsx("div", { className: "mt-6 flex items-center gap-2 text-xs uppercase tracking-widest text-ivory/60", children: business.sloganParts.map((part, index) => /* @__PURE__ */ jsxs("span", { className: "flex items-center gap-2", children: [
          part,
          index < business.sloganParts.length - 1 ? /* @__PURE__ */ jsx("span", { children: "·" }) : null
        ] }, part)) }),
        /* @__PURE__ */ jsxs("div", { className: "mt-8 flex gap-4", children: [
          /* @__PURE__ */ jsx("a", { href: "#", "aria-label": "Instagram", className: "text-ivory/70 hover:text-ivory", children: /* @__PURE__ */ jsx(Instagram, { className: "h-5 w-5" }) }),
          /* @__PURE__ */ jsx("a", { href: "#", "aria-label": "Facebook", className: "text-ivory/70 hover:text-ivory", children: /* @__PURE__ */ jsx(Facebook, { className: "h-5 w-5" }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("p", { className: "text-xs font-semibold uppercase tracking-widest text-ivory/50", children: "Navegação" }),
        /* @__PURE__ */ jsxs("ul", { className: "mt-5 space-y-3 text-sm", children: [
          /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, { to: "/services", className: "hover:text-ivory/70", children: "Serviços" }) }),
          /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, { to: "/about", className: "hover:text-ivory/70", children: "Sobre" }) }),
          /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, { to: "/reviews", className: "hover:text-ivory/70", children: "Avaliações" }) }),
          /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, { to: "/location", className: "hover:text-ivory/70", children: "Localização" }) }),
          /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, { to: "/book", className: "hover:text-ivory/70", children: "Agendar" }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("p", { className: "text-xs font-semibold uppercase tracking-widest text-ivory/50", children: "Serviços" }),
        /* @__PURE__ */ jsx("ul", { className: "mt-5 space-y-3 text-sm", children: services.map((service2) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, { to: `/services/${service2.slug}`, className: "hover:text-ivory/70", children: service2.name }) }, service2.slug)) })
      ] }),
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("p", { className: "text-xs font-semibold uppercase tracking-widest text-ivory/50", children: "Visite-nos" }),
        /* @__PURE__ */ jsxs("ul", { className: "mt-5 space-y-3 text-sm text-ivory/80", children: [
          /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-2", children: [
            /* @__PURE__ */ jsx(MapPin, { className: "mt-0.5 h-4 w-4 shrink-0" }),
            /* @__PURE__ */ jsx("span", { children: business.address })
          ] }),
          /* @__PURE__ */ jsxs("li", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx(Phone, { className: "h-4 w-4 shrink-0" }),
            /* @__PURE__ */ jsx("a", { href: `tel:${business.phoneHref}`, className: "hover:text-ivory", children: business.phone })
          ] }),
          /* @__PURE__ */ jsxs("li", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx(Mail, { className: "h-4 w-4 shrink-0" }),
            /* @__PURE__ */ jsx("a", { href: `mailto:${business.email}`, className: "hover:text-ivory", children: business.email })
          ] })
        ] }),
        /* @__PURE__ */ jsxs(
          "form",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx(Button, { type: "submit", variant: "ivory", size: "sm", children: "Assinar" })
            ]
          }
        )
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "mt-16 flex flex-col gap-4 border-t border-ivory/15 pt-8 text-xs text-ivory/50 sm:flex-row sm:items-center sm:justify-between", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex gap-6", children: [
        /* @__PURE__ */ jsx("a", { href: "#", className: "hover:text-ivory/80", children: "Política de privacidade" }),
        /* @__PURE__ */ jsx("a", { href: "#", className: "hover:text-ivory/80", children: "Termos de uso" })
      ] })
    ] })
  ] }) });
}
...
const $$splitComponentImporter$b = () => import("./services-BFsOu0JM.js");
const Route$b = createFileRoute("/services")({
  component: lazyRouteComponent($$splitComponentImporter$b, "component")
});
const $$splitComponentImporter$a = () => import("./reviews-Bj9Tw9Ee.js");
...
const $$splitComponentImporter$9 = () => import("./location-u7Lb38oy.js");
...
const $$splitComponentImporter$8 = () => import("./book-D2U0dJUd.js");
...
const $$splitComponentImporter$7 = () => import("./about-JudjePKU.js");
...
const $$splitComponentImporter$6 = () => import("./index-BWSlEOev.js");
...
const $$splitComponentImporter$5 = () => import("./services.index-jxrde9k0.js");
...
const $$splitComponentImporter$4 = () => import("./services.premium-beard-To2yZfIH.js");
...
const $$splitComponentImporter$3 = () => import("./services.haircut-beard-Bhuy2B9z.js");
...
const $$splitComponentImporter$2 = () => import("./services.father-son-BhPe_yaC.js");
...
const $$splitComponentImporter$1 = () => import("./services.executive-cut-w8lA5TQU.js");
...
const $$splitComponentImporter = () => import("./services.classic-cut-D0e9hJMb.js");
